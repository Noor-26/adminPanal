...
<div className='ml-2'>
<p className="font-semibold  text-[#165DC5]"> SBD / BOQ  Progress Entry / Update</p>
<p className='text-[14px] capitalize font-semibold text-[#959298]'>Most asked questions</p>
</div>
    </div>
    
    <Link to="/sparprogresslist" ><button className=" bg-btn_def border-none hover:bg-btn_def py-2 px-8 uppercase text-white rounded text-[15px] flex items-center"> <span className='py-1 px-2 mr-2 rounded relative right-[5px] text-center mx-auto bg-white '><CgPlayListCheck className="text-[22px] bg-white mx-auto relative left-[2px] text-center text-btn_def  font-bold "/> </span> SBD / BOQ  Progress list </button></Link>
    </div>
...
<div className='ml-2'>
<p className="font-semibold  text-[#165DC5]"> SBD / BOQ  Progress</p>
</div>
    </div>
