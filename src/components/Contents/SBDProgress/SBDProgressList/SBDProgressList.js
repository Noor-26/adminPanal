...
import SBDProgressTable from './SBDProgressTable'
...
<div className='ml-2'>
    <p className="font-semibold capitalize text-[20px] text-[#165DC5]">SBD / BOQ Progress List</p>
    <p className='text-[14px] capitalize text-[#959298]'>Most asked questions</p>
</div>
        </div>
  
   <Link to="/sbdprogress" ><button className=" bg-btn_def border-none hover:bg-btn_def py-2 px-4 uppercase text-white rounded-md text-[15px] flex items-center"> <span className='py-2 pl-2 mr-2 rounded relative right-[5px] text-center mx-auto bg-white '><HiPlus className="text-[18px] bg-white mx-auto text-center text-btn_def  font-bold mr-2"/> </span> Add new SBD / BOQ progress list </button></Link>
...
export default SBDProgressList