...
<div className='ml-2'>
    <p className="font-semibold capitalize text-[20px] text-[#165DC5]">Procurement Progress</p>
</div>
        </div>
        <Link to="/subprojectlist" >
        <button className=" bg-btn_def border-none hover:bg-btn_def py-2 pr-8 uppercase text-white rounded-md text-[15px] flex items-center"> <span className='py-1 px-2 mx-4 rounded relative  text-center  bg-white '><CgPlayListCheck className="text-[22px] bg-white mx-auto relative left-[2px] text-center text-btn_def  font-bold "/> </span> Procurement progress list</button>
          </Link>
