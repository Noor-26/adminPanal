...
import activityimg from '../../../images/phone.png'
const Activityprojects = () => {
  ...
  <div className="w-12 rounded">
    <img src={activityimg} alt="Tailwind-CSS-Avatar-component" />
  </div>
</div>
<div className='ml-2'>
    <p className="font-semibold capitalize text-[#165DC5]">Activity Timeline</p>
  ...
  <select className="select select-bordered">
    ...
    <div className='pl-3'>
        ...
        <div className="card rounded-md mt-8 card-compact border w-full bg-base-100 p-4 shadow">
  <p className='p-2'>Activity Timeline</p>
</div>
