...
<div className='ml-2'>
    ...
    <p className='text-[14px] capitalize  text-[#959298]'>page instructions</p>
          ...
          <Link to="/subprojectlist" ><button className=" bg-btn_def border-none hover:bg-btn_def py-2 pr-8 uppercase text-white rounded-md text-[15px] flex items-center"> <span className='py-1 px-2 mx-4 rounded relative  text-center  bg-white '><CgPlayListCheck className="text-[22px] bg-white mx-auto relative left-[2px] text-center text-btn_def  font-bold "/> </span> Sub Project list </button></Link>
        </div>
